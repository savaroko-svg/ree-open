...
GL_APICALL void           (* GL_APIENTRY glGetTransformFeedbackVarying) (GLuint program, GLuint index, GLsizei bufSize, GLsizei* length, GLsizei* size, GLenum* type, const char *name);
...
GL_APICALL const GLubyte* (* GL_APIENTRY glGetStringi) (GLenum GLuint
const char *name
index);
